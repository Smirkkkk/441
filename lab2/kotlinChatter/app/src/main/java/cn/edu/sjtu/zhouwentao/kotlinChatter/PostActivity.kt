...
import cn.edu.sjtu.zhouwentao.kotlinChatter.ChattStore.postChatt
import cn.edu.sjtu.zhouwentao.kotlinChatter.databinding.ActivityPostBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        view.videoButton.setOnClickListener {
            ...
            viewState.videoUri?.let {
                captureVideoLauncher.launch(it)
            }
        }
    }
